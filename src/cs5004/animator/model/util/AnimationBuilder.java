...
/**
 * This interface outlines the methods available to an animation that
 * will be built using the Builder Design Pattern.
 * @param <Doc> a concrete class or interface implemented by the class
 *     utilizing this builder.
 */

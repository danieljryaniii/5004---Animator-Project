...
/**
 * A JUnit Testing Suite for the Ellipse class which is a child
 * class of the AbstractShapeAnimation class.
 */
public class EllipseTest {

  /**
   * Test the Constructor/Builder method of the Ellipse class.
   */
  @Test
  public void testConstructor() {
    // Test Builder with only required argument
    ShapeAnimation test = new Ellipse.Builder("test").build();
    // Given Values
  ...
  /**
   * Test the moveShape method of the Ellipse class.
   */
  @Test
  public void testMove() {
    ...
    // Set Start to (0, 0)
    ShapeAnimation test = new Ellipse.Builder("test").referencePoint(new Point2D(0, 0)).build();
  ...
  /**
   * Test valid scale method of the Ellipse class.
   */
  @Test
  ...
  /**
   * Test invalid scale method of the Ellipse class.
   */
  @Test
  ...
  /**
   * Test the showShape method of the Ellipse class.
   */
  @Test
  ...
  /**
   * Test the hideShape method of the Ellipse class.
   */
  @Test
  public void testHideShape() {
    ...
    test = new Ellipse.Builder("test").visibility(true).build();
    assertTrue(test.isVisible());
  ...
  /**
   * Test valid setWidth method of the Ellipse class.
   */
  @Test
  ...
  /**
   * Test invalid setWidth method of the Ellipse class.
   */
  @Test
  ...
  /**
   * Test valid setHeight method of the Ellipse class.
   */
  @Test
  ...
  /**
   * Test invalid setHeight method of the Ellipse class.
   */
  @Test
  ...
  /**
   * Test valid setAppearTime method of the Ellipse class.
   */
  @Test
  ...
  /**
   * Test invalid setAppearTime method of the Ellipse class.
   */
  @Test
  ...
  /**
   * Test valid setRemoveTime method of the Ellipse class.
   */
  @Test
  ...
  /**
   * Test invalid setRemoveTime method of the Ellipse class.
   */
  @Test
  ...
  /**
   * Test the setColor method of the Ellipse class.
   */
  @Test
  ...
  /**
   * Test the getName method of the Ellipse class.
   */
  @Test
  public void testGetName() {
    ...
    test = new Ellipse.Builder("shape1").build();
    assertEquals("shape1", test.getName());
    
    test = new Ellipse.Builder("SHAPE2").build();
    assertEquals("SHAPE2", test.getName());
    
    test = new Ellipse.Builder("SHapE").build();
  ...
  /**
   * Test the getPosition method of the Ellipse class.
   */
  @Test
  public void testGetPosition() {
    ...
    test = new Ellipse.Builder("test").referencePoint(new Point2D(200, 100)).build();
  ...
  /**
   * Test the getColor method of the Ellipse class.
   */
  @Test
  public void testGetColor() {
    ...
    test = new Ellipse.Builder("test").color(new ShapeColor(100, 255, 10)).build();
  ...
  /**
   * Test the getWidth method of the Ellipse class.
   */
  @Test
  public void testGetWidth() {
    ...
    test = new Ellipse.Builder("test").width(100.50).build();
  ...
  /**
   * Test the getHeight method of the Ellipse class.
   */
  @Test
  public void testGetHeight() {
    ...
    test = new Ellipse.Builder("test").height(50.5).build();
  ...
  /**
   * Test the getAppearTime method of the Ellipse class.
   */
  @Test
  public void testGetAppearTime() {
    ...
    test = new Ellipse.Builder("test").appearTime(100).build();
  ...
  /**
   * Test the getRemoveTime method of the Ellipse class.
   */
  @Test
  public void testGetRemoveTime() {
    ...
    // Build Shape with remove time
    test = new Ellipse.Builder("test").removeTime(100).build();
  ...
  /**
   * Test the isVisible method of the Ellipse class.
   */
  @Test
  ...
  /**
   * Test the toString method of the Ellipse class.
   */
  @Test
  public void testToString() {
    ...
    expected =     
          "Name: test\n"
        + "Type: ellipse\n"
        + "Center: (3221225470.50, 3221225470.50)\n"
        + "X Radius: 1.0737418235E9\n"       // Double
        + "Y Radius: 1.0737418235E9\n"       // Double
    ...
    expected =     
        "Name: test\n"
      + "Type: ellipse\n"
      + "Center: (1073741923.50, 1073741923.50)\n"
      + "X Radius: 1.0737418235E9\n"       // Double
      + "Y Radius: 1.0737418235E9\n"       // Double
      + "Color: (0.00, 0.00, 0.00)\n"
      + "Appear At: 2147483647\n"
  ...
  /**
   * Test the getType method of the Ellipse class.
   */
  @Test
  public void testGetType() {
    // Test default ellipse
    ShapeAnimation test = new Ellipse.Builder("test").build();
    assertEquals(ShapeType.ELLIPSE, test.getType());
    
    // Test ellipse with attributes
    test = new Ellipse.Builder("test")
                        .referencePoint(new Point2D(100, 100))
  ...
  /**
   * Test the cloneShape method of the Ellipse class.
   */
  @Test
  public void testCloneShape() {
    // Create Ellipse with instantiated fields
    ShapeAnimation test = new Ellipse.Builder("test")

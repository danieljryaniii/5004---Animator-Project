...
/**
 * A JUnit Testing Suite for the MoveAnimation class.
 */
public class MoveAnimationTest {


  /**
   * Test the Constructor of the MoveAnimation Class on valid
   * input.
   */
  @Test
  public void testConstructor() {
    ...
    try {
      ...
      IAnimation test = new MoveAnimation(
            shape,
            AnimationType.MOVE,
            new Point2D(0, 0),
            new Point2D(100, 100),
      ...
      assertEquals(AnimationType.MOVE, test.getType());
      ...
      fail("Exception should not have been thrown on MoveAnimation construction.");
    }
  }
  
  /**
   * Test the Constructor of the MoveAnimation Class on invalid
   * input.
   */
  @Test
  public void testInvalidConstructor() {
    ...
    for (int num = -5000; num < 0; num ++) {
      try {
        ...
        fail("Exception should have been thrown on MoveAnimation construction.");
      } catch (IllegalArgumentException iae) {
        // DO Noting -- Pass
      }
    }
  ...
  /**
   * Test the getShape method of the MoveAnimation class.
   */
  @Test
  ...
  /**
   * Test the getType method of the MoveAnimation class.
   */
  @Test
  public void testGetType() {
    try {
      ...
      assertEquals(AnimationType.MOVE, test.getType());
      assertNotEquals(AnimationType.SCALE, test.getType());
  ...
  /**
   * Test the getStartPosition method of the MoveAnimation class.
   */
  @Test
  ...
  /**
   * Test the getEndPosition method of the MoveAnimation class.
   */
  @Test
  ...
  /**
   * Test the getStartColor method of the MoveAnimation class.
   */
  @Test
  ...
  /**
   * Test the getEndColor method of the MoveAnimation class.
   */
  @Test
  ...
  /**
   * Test the getStartTime method of the MoveAnimation class.
   */
  @Test
  ...
  /**
   * Test the getEndTime method of the MoveAnimation class.
   */
  @Test
  ...
  /**
   * Test the getStartWidth method of the MoveAnimiation class.
   */
  @Test
  ...
  /**
   * Test the getEndWidth method of the MoveAnimation class.
   */
  @Test
  ...
  /**
   * Test the getStartHeight method of the MoveAnimation class.
   */
  @Test
  ...
  /**
   * Test the getEndHeight method of the MoveAnimation class.
   */
  @Test
  ...
  /**
   * Test the toString method of the MoveAnimation class.
   */
  @Test
  public void testToString() {
    ...
    try {
      ...
      String expected = 
          "testShape moved from (0.00, 0.00) to (100.00, 100.00) from t=1 to t=100";
      
      assertEquals(expected, test.toString());

      
      ShapeAnimation shapeE = new Ellipse.Builder("testEllipse").build();
      IAnimation testEllipse = new MoveAnimation(
          shapeE, AnimationType.MOVE, new Point2D(440, 70), new Point2D(440, 370),
          new ShapeColor(255, 255, 255), new ShapeColor(255, 255, 255),
          6, 100, 120, 120, 60, 60
          );
      
      expected = 
          "testEllipse moved from (500.00, 100.00) to (500.00, 400.00) from t=6 to t=100";
      
      assertEquals(expected, testEllipse.toString());
  ...
  /**
   * Test the cloneAnimation method of the MoveAnimiation class.
   */
  @Test
  public void testCloneAnimation() {
    ...
    try {
      ...
      assertEquals(AnimationType.MOVE, testClone.getType());
